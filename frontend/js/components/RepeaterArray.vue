<template>
  <div class="content">
    ...
    <div class="content__trigger">
      <div class="content__button_add" v-for="(blockType, index) in blockTypes" :key="index">
        <a17-button :class="triggerClass" :variant="triggerVariant" :size="triggerSize" @click="addBlock(blockType.type, blockType.type)" v-if="hasRemainingBlocks && blockType.trigger">{{ blockType.trigger }}</a17-button>
      </div>
